...
if ((getPlayerUID player) in ["76561198107239333","76561198132857467","76561197963195089"]) then { // Admin PlayerID Eintragen
	...
	if ((getPlayerUID player) in ["76561198107239333","76561198132857467","76561197963195089"]) then { // Super Admin PlayerID Eintragen
		adminmenu =
		[
			["",true],
