...
_role1names = ["[GER] Altis Life RPG [3.1.3|HOUSING|GANGS|MEDICS/ADAC|GEAR-SAVE|Active Admins| RPG]"];
_role2 = "Server admins!";
_role2names = ["Cedi","Demon","Snake"];
_role3 = "Website:";
_role3names = ["http://herosfactory.forumprofi.de/"];
_role4 = "Teamspeak:";
_role4names = ["78.143.39.207:22400"];
_role5 = "NEWS:";
_role5names = ["Altis Life 3.1.3+", "Medics die Funktionieren", "ADAC", "Sicherheitsdienst", "Freundliche Polizisten", "Nervige Terroristen"];
_role6 = "Fragen?";
...
_role9 = "Edited by:";
_role9names = ["[SD] Demon"];

_role10 = "Special thanks to:";
_role10names = ["TAW_Tonic", "Bruuudis - Housing Script", "Demon"];
