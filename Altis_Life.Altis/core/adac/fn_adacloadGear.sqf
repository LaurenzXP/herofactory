/*
	...
	Description:
	Used for loading adac saved gear loadout.
*/
...
if(isNil "_loadout") exitWith {[] call life_fnc_adacDefault;}; //Slot data doesn't exist
if(count _loadout == 0) exitWith {[] call life_fnc_adacDefault;}; //Slot data doesn't exist
