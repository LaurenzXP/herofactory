...
switch (_side) do {
	...
	case east: {_query = format["UPDATE players SET name='%1', cash='%2', bankacc='%3', adac_licenses='%4', adac_gear='%5' WHERE playerid='%6'",_name,_cash,_bank,_licenses,_uid];};

};

diag_log "update query from fn_updateRequest.sqf";
diag_log _query;
